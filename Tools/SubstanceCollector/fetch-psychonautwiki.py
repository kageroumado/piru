...
`ingest_psychonautwiki_snapshot` in `Exports/build-sqlite-database.py` — same
schema as `sourced-substances.json`, with `provenance = "psychonautwiki"`.
"""
...
OUTPUT = Path(__file__).resolve().parent.parent.parent / "Piru" / "Data" / "psychonautwiki-snapshot.json"
