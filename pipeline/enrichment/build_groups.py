...
def route_substance(entry: dict) -> str:
    ...
    if has_name(
        ...
        "tyramine",
        "selegiline",
        "rasagiline",  # MAOIs but stimulant-effect
        "ephedrine",
        "pseudoephedrine",
        "synephrine",
        "norephedrine",
    ...
    if (
        ...
        or "benzodiazepine" in tags
        or "designer-benzo" in tags
        or "thienodiazepine" in tags
    ...
    if (
        category == "GABAergic"
        or category == "Depressant"
        or "GABAA-PAM" in tags
        or "GABA-B-agonist" in tags
    ...
    if has_name(
        ...
        "pea-cannabinoid",
        "yohimbine",
    ):  # NOTE yohimbine is α2-antagonist; will check
