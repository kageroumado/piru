...
Usage:
    python3 Exports/dump-substances-for-verification.py [output_dir]

Defaults to `Exports/verification-dump/`.
"""
...
def main() -> int:
    out_dir = Path(sys.argv[1]) if len(sys.argv) > 1 else REPO / "Exports/verification-dump"
