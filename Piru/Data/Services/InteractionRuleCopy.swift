...
enum InteractionRuleCopy {
    ...
    private static let entries: [(DrugClass, DrugClass, LocalizedStringResource)] = [
        ...
        (.lithium, .psychedelic, "Risk of seizures and serotonin toxicity — well-documented dangerous combination."),
        ...
        (.dissociative, .benzodiazepine, "Significant respiratory depression risk and profound loss of consciousness."),
        ...
        (.serotonergic, .lithium, "Increased serotonin syndrome risk — lithium adds to the serotonergic load."),
        ...
        (.lithium, .ssri, "Increased risk of serotonin syndrome and lithium toxicity."),
        (.lithium, .snri, "Increased risk of serotonin syndrome and lithium toxicity."),
        ...
        (.barbiturate, .antihistamine, "Heavy additive sedation — profound drowsiness and impaired breathing."),
        ...
        (.lithium, .empathogen, "Risk of seizures and serotonin toxicity — potentially fatal combination."),
        (.lithium, .maoi, "Risk of serotonin syndrome and lithium toxicity."),
        (.stimulant, .ssri, "Some combinations increase serotonin or seizure risk — monitor for symptoms."),
        (.stimulant, .snri, "Cardiovascular strain and potential serotonin interaction — monitor heart rate and blood pressure."),
