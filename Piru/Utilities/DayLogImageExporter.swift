...
enum DayLogImageExporter {
    ...
    @MainActor static func generateImage(
        ...
        let height = calculateHeight(entries: entryData, summary: summary)
        ...
        return renderer.image { ctx in
            ...
            drawImage(context: context, size: size, date: date, entries: entryData, summary: summary)
        }
    }
    
    // MARK: - Height Calculation
    
    private static func calculateHeight(entries: [EntryData], summary: DaySummary) -> CGFloat {
