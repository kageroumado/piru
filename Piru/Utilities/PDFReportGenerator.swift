...
nonisolated enum PDFReportGenerator {
    ...
    private static func drawFooter(_ cursor: inout Cursor) {
        let disclaimerText = "This report was generated by Piru for informational purposes. It is not medical advice. Always consult a qualified healthcare provider regarding substance use and medication management."
