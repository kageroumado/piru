...
private struct PushRouteView: View {
    ...
    private func insightView(for insight: Insight) -> some View {
        ...
        case .hormoneLevels: HormoneLevelsView().navigationTitle("Hormone Levels")
        case .patterns: PatternsView().navigationTitle("Patterns")
        case .feltPatterns: FeltPatternsView().navigationTitle("Did it work?")
